// Description: A script to sort imports in JavaScript and TypeScript files
// by line length
// using regex and fs modules
...
const directoryPath = path.join(__dirname, baseUrl); // Adjust to your src folder path
